...
set rc [catch {
  ...
  open_checkpoint F:/Xilinx/Vivado_code/Question_4/full_subtractor/full_subtractor.runs/impl_1/full_sub.dcp
  set_property webtalk.parent_dir F:/Xilinx/Vivado_code/Question_4/full_subtractor/full_subtractor.cache/wt [current_project]
  set_property parent.project_path F:/Xilinx/Vivado_code/Question_4/full_subtractor/full_subtractor.xpr [current_project]
  set_property ip_repo_paths f:/Xilinx/Vivado_code/Question_4/full_subtractor/full_subtractor.cache/ip [current_project]
  set_property ip_output_repo f:/Xilinx/Vivado_code/Question_4/full_subtractor/full_subtractor.cache/ip [current_project]
